...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/kenzolan/test/master/conf/squid.conf" 
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/kenzolan/test/master/conf/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by MKSSHVPN </pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/kenzolan/test/master/conf/vps.conf"
